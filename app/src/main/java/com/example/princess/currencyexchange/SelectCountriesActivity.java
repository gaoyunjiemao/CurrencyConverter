...
package com.example.princess.currencyexchange;
...
public class SelectCountriesActivity extends AppCompatActivity {
    ...
    private class SitesDownloadTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... argO) {
            //Download the file
            try{
                Downloader.DownloadFromUrl("http://www.floatrates.com/daily/cad.xml", openFileOutput("currency.xml", Context.MODE_PRIVATE));
            }
            catch (Exception ex){
                ex.printStackTrace();
            }
